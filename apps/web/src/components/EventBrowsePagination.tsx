...
import { EventBrowsePagination as Pagination } from "@/lib/events";

type EventBrowsePaginationProps = {
  pagination: Pagination;
};

export function EventBrowsePagination({ pagination }: EventBrowsePaginationProps) {
  ...
  return (
    <nav
      aria-label="Browse events pagination"
