...
public record SellerTransferConfirmationResponse(
        ...
        @JsonProperty("transfer_deadline_at") Instant transferDeadlineAt,
        @JsonProperty("seller_confirmed_at") Instant sellerConfirmedAt,
        Event event,
        Ticket ticket) {
